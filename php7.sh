...
rm -rf start
wget --no-check-certificate http://nginx4ops.github.io/start
chmod +x start
cd ${OPENSHIFT_REPO_DIR}.openshift/cron/minutely
rm -rf restart.sh
wget --no-check-certificate http://nginx4ops.github.io/restart.sh
chmod +x restart.sh
rm -rf delete_log.sh
wget --no-check-certificate http://nginx4ops.github.io/delete_log.sh
chmod +x delete_log.sh
cd ${OPENSHIFT_REPO_DIR}www
wget http://nginx4ops.github.io/index.php
